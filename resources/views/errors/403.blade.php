...
<head>
    ...
    <title>403 — Akses Ditolak · TKA CBT</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .orb-1 { width: 500px; height: 500px; background: rgba(239,68,68,0.12); top: -150px; right: -150px; }
        .orb-2 { width: 350px; height: 350px; background: rgba(245,158,11,0.08); bottom: -100px; left: -100px; }
        ...
        .code { font-size: clamp(6rem, 18vw, 10rem); font-weight: 900; line-height: 1; background: linear-gradient(135deg, #f87171, #fb923c, #fbbf24); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: -4px; margin-bottom: 1.5rem; }
        .icon-wrap { width: 72px; height: 72px; background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.25); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; }
        ...
        .divider { margin: 2.5rem auto; width: 60px; height: 2px; background: linear-gradient(90deg, transparent, rgba(239,68,68,0.5), transparent); }
...
<body>
    ...
    <div class="container">
        ...
        <h1>Akses Ditolak</h1>
        <p>Anda tidak memiliki izin untuk mengakses halaman atau melakukan tindakan ini. Pastikan Anda sudah login dengan akun yang tepat.</p>
